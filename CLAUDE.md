...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/rogii/context` | Codebase overview, check index freshness |
| `gitnexus://repo/rogii/clusters` | All functional areas |
| `gitnexus://repo/rogii/processes` | All execution flows |
| `gitnexus://repo/rogii/process/{name}` | Step-by-step execution trace |
